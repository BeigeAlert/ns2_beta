Log("Loading modified EvolutionChamber.lua for NS2 Balance Beta mod.")
...
EvolutionChamber.kUpgradeButtons ={                            
    ...
    [kTechId.FadeMenu] = { kTechId.MetabolizeEnergy, kTechId.MetabolizeHealth, kTechId.None, kTechId.None,
                                 kTechId.None, kTechId.None, kTechId.None, kTechId.None },
